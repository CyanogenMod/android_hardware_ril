...
radio_library_libs := rild

ifeq ($(TARGET_WANTS_MOCK_RIL),true)
	radio_library_libs += mock-ril
endif

ifeq ($(TARGET_WANTS_REFERENCE_RIL),true)
	radio_library_libs += reference-cdma-sms reference-ril
endif
